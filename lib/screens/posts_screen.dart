...
class _PostScreenState extends State<PostScreen> {
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final fetchedPostImage =
                            data[index]['postImage'] as ParseFile?;
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      child: fetchedPostImage != null
                                          ? Image.network(
                                              fetchedPostImage.url!,
                                              fit: BoxFit.cover,
                                            )
                                          : const Icon(
  ...
  Future<ParseFile?> getPostImage(ParseObject post) async {
